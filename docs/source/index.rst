...
Autocalc is a framework aimed primarily at creating apps from you Jupyter notebooks.
...
.. code-block::
    ...
    freq =  Var('Frequency', initial_value='B', widget=widgets.Dropdown(options=FREQ.items()), description='Frequency of portoflio loading dates')
